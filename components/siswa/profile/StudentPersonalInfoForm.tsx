...
export function StudentPersonalInfoForm({
  data,
  onChange,
  onSave,
  isPending,
  ...
  const fields: Array<{
    ...
    { id: "hobby", label: "Hobi / Minat", icon: Heart, type: "text" },
    { id: "parent_name", label: "Nama Orang Tua", icon: Baby, type: "text" },
    {
  ...
  return (
    <AppCard className="space-y-6 border-slate-100 shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
        <h3 className="text-lg font-bold text-slate-800">Biodata Pelajar</h3>
        <AppButton
          onClick={onSave}
          isLoading={isPending}
